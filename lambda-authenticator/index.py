...
def generate_token(payload: dict) -> str:
    ...
    payload.update({
      'iat': timestamp,
      'exp': timestamp + (60*60*1) # timestamp plus 1 hour
    })
...
if ENV == 'local':
    event =  {'resource': '/signin', 'path': '/signin', 'httpMethod': 'POST', 'headers': {}, 'multiValueHeaders': {}, 'queryStringParameters': None, 'multiValueQueryStringParameters': None, 'pathParameters': None, 'stageVariables': None, 'requestContext': {'resourceId': 'aaaa', 'resourcePath': '/signin', 'httpMethod': 'POST', 'extendedRequestId': 'A=', 'requestTime': '15/May/2022:00:00:00 +0000', 'path': '/authorizer/signin', 'accountId': '000000000000', 'protocol': 'HTTP/1.1', 'stage': 'authorizer', 'domainPrefix': 'aaaa', 'requestTimeEpoch': 0, 'requestId': 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'identity': {}, 'domainName': '', 'apiId': 'aaaa'}, 'body': '{"email": "julioscheidt@mail.com", "password": "PASSWORD"}', 'isBase64Encoded': False}
